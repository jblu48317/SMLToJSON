...
public class SmlToJSONMulticast {
	...
	private static int MC_Port         = -1;
	private static String MC_Address = "224.0.113.0";
//	private static int MC_Timeout      = 10000; // 10 seconds
	private static MulticastPublisher MC_Publisher = null;
	...
	private static void processSMLReading()
	{
		...
		if(MC_Publisher != null)
		{
			...
			// System.err.println("Multicast: " + jsonMeterReading);
	...
	private static boolean processCommandLine(String[] args)
	{
		...
		{
			String opStr = (String) options.valueOf("mc");
